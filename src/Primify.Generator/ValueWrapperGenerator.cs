...
namespace Primify.Generator
{
    ...
    public class ValueWrapperGenerator : IIncrementalGenerator
    {
        ...
        private static string GenerateImplementation(WrapperTypeInfo info, Compilation compilation)
        {
            ...
            // Type doc comment
            CodeBuilder.AppendTypeSummary(sb, $"Represents a value wrapper for <see cref=\"{info.PrimitiveTypeName}\"/>.");
            sb.AppendLine("/// Generated by ValueWrapperGenerator.");
            CodeBuilder.EnsureBlankLine(sb);
