...
public class ReadonlyStructEqualityTests
{
    //================================================================================
    ...
    {
        // Arrange
        var objectId = ReadonlyStructId.From(123);
        var expectedString = $"{nameof(ReadonlyStructId)} {{ Value = 123 }}";
    ...
    {
        // Arrange
        var objectId1 = ReadonlyStructId.From(100);
        var objectId2 = ReadonlyStructId.From(100); // Different instance, same value
    ...
    public void Equality_ForDifferentValues_ShouldBeFalse()
    {
        // Arrange
        var objectId1 = ReadonlyStructId.From(100);
        var objectId2 = ReadonlyStructId.From(200);
    ...
    {
        // Arrange
        var objectId = ReadonlyStructId.From(100);
    ...
    {
        // Arrange
        ReadonlyStructId? null1 = null;
        ReadonlyStructId? null2 = null;
    ...
    public void GetHashCode_ForEqualObjects_ShouldBeEqual()
    {
        // Arrange
        var objectId1 = ReadonlyStructId.From(100);
        var objectId2 = ReadonlyStructId.From(100);
    ...
    {
        // Arrange
        var set = new HashSet<ReadonlyStructId>();
        var objectId1 = ReadonlyStructId.From(100);
        var objectId2 = ReadonlyStructId.From(100); // Equal, but different instance
    ...
    {
        // Arrange
        var dictionary = new Dictionary<ReadonlyStructId, string>();
        var key1 = ReadonlyStructId.From(50);
        var key2 = ReadonlyStructId.From(50); // Equal, but different instance
