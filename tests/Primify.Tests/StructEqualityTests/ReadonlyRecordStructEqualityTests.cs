namespace Primify.Generator.Tests.StructEqualityTests;

public class ReadonlyRecordStructEqualityTests
{
    //================================================================================
    ...
    public void From_CreatesInstanceWithCorrectValue()
    {
        ...
        // Act
        var objectId = ReadonlyRecordStructId.From(value);
    ...
    public void ExplicitCast_FromUnderlyingType_CreatesInstance()
    {
        ...
        // Act
        var objectId = (ReadonlyRecordStructId)value;
    ...
    {
        // Arrange
        var objectId1 = ReadonlyRecordStructId.From(100);
        var objectId2 = ReadonlyRecordStructId.From(100); // Different instance, same value
    ...
    public void Equality_ForDifferentValues_ShouldBeFalse()
    {
        // Arrange
        var objectId1 = ReadonlyRecordStructId.From(100);
        var objectId2 = ReadonlyRecordStructId.From(200);
    ...
    // {
    //     // Arrange
    //     var objectId = ReadonlyRecordStructId.From(100);
    //
    //     // Assert
    ...
    {
        // Arrange
        ReadonlyRecordStructId? null1 = null;
        ReadonlyRecordStructId? null2 = null;
    ...
    public void GetHashCode_ForEqualObjects_ShouldBeEqual()
    {
        // Arrange
        var objectId1 = ReadonlyRecordStructId.From(100);
        var objectId2 = ReadonlyRecordStructId.From(100);
    ...
    {
        // Arrange
        var set = new HashSet<ReadonlyRecordStructId>();
        var objectId1 = ReadonlyRecordStructId.From(100);
        var objectId2 = ReadonlyRecordStructId.From(100); // Equal, but different instance
    ...
    {
        // Arrange
        var dictionary = new Dictionary<ReadonlyRecordStructId, string>();
        var key1 = ReadonlyRecordStructId.From(50);
        var key2 = ReadonlyRecordStructId.From(50); // Equal, but different instance
