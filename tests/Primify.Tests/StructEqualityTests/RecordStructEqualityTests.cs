...
public class RecordStructEqualityTests
{
    ...
    {
        // Arrange
        var objectId1 = RecordStructId.From(100);
        var objectId2 = RecordStructId.From(100); // Different instance, same value
    ...
    public void Equality_ForDifferentValues_ShouldBeFalse()
    {
        // Arrange
        var objectId1 = RecordStructId.From(100);
        var objectId2 = RecordStructId.From(200);
    ...
    {
        // Arrange
        var objectId = RecordStructId.From(100);
    ...
    {
        // Arrange
        RecordStructId? null1 = null;
        RecordStructId? null2 = null;
    ...
    public void GetHashCode_ForEqualObjects_ShouldBeEqual()
    {
        // Arrange
        var objectId1 = RecordStructId.From(100);
        var objectId2 = RecordStructId.From(100);
    ...
    {
        // Arrange
        var set = new HashSet<RecordStructId>();
        var objectId1 = RecordStructId.From(100);
        var objectId2 = RecordStructId.From(100); // Equal, but different instance
    ...
    {
        // Arrange
        var dictionary = new Dictionary<RecordStructId, string>();
        var key1 = RecordStructId.From(50);
        var key2 = RecordStructId.From(50); // Equal, but different instance
