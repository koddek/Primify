...
public class StructEqualityTests
{
    ...
    {
        // Arrange
        var objectId1 = StructId.From(100);
        var objectId2 = StructId.From(100); // Different instance, same value
    ...
    public void Equality_ForDifferentValues_ShouldBeFalse()
    {
        // Arrange
        var objectId1 = StructId.From(100);
        var objectId2 = StructId.From(200);
    ...
    {
        // Arrange
        var objectId = StructId.From(100);
    ...
    public void GetHashCode_ForEqualObjects_ShouldBeEqual()
    {
        // Arrange
        var objectId1 = StructId.From(100);
        var objectId2 = StructId.From(100);
    ...
    {
        // Arrange
        var set = new HashSet<StructId>();
        var objectId1 = StructId.From(100);
        var objectId2 = StructId.From(100); // Equal, but different instance
    ...
    {
        // Arrange
        var dictionary = new Dictionary<StructId, string>();
        var key1 = StructId.From(50);
        var key2 = StructId.From(50); // Equal, but different instance
