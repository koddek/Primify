...
public class ClassEqualityTests
{
    ...
    public void From_CreatesInstanceWithCorrectValue()
    {
        ...
        // Act
        var objectId = ClassId.From(value);
    ...
    {
        // Arrange
        var objectId1 = ClassId.From(100);
        var objectId2 = ClassId.From(100); // Different instance, same value
    ...
    public void Equality_ForDifferentValues_ShouldBeFalse()
    {
        // Arrange
        var objectId1 = ClassId.From(100);
        var objectId2 = ClassId.From(200);
    ...
    public void GetHashCode_ForEqualObjects_ShouldBeEqual()
    {
        // Arrange
        var objectId1 = ClassId.From(100);
        var objectId2 = ClassId.From(100);
    ...
    {
        // Arrange
        var set = new HashSet<ClassId>();
        var objectId1 = ClassId.From(100);
        var objectId2 = ClassId.From(100); // Equal, but different instance
    ...
    public void Dictionary_ShouldRetrieveValueWithEqualKey()
    {
        ...
        var key1 = ClassId.From(50);
        var key2 = ClassId.From(50); // Equal, but different instance
