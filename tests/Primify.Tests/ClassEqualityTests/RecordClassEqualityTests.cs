...
public class RecordClassEqualityTests
{
    ...
    public void From_CreatesInstanceWithCorrectValue()
    {
        ...
        // Act
        var objectId = RecordClassId.From(value);
    ...
    public void ExplicitCast_FromUnderlyingType_CreatesInstance()
    {
        ...
        // Act
        var objectId = (RecordClassId)value;
    ...
    {
        // Arrange
        var objectId1 = RecordClassId.From(100);
        var objectId2 = RecordClassId.From(100); // Different instance, same value
    ...
    public void Equality_ForDifferentValues_ShouldBeFalse()
    {
        // Arrange
        var objectId1 = RecordClassId.From(100);
        var objectId2 = RecordClassId.From(200);
    ...
    {
        // Arrange
        var objectId = RecordClassId.From(100);
    ...
    {
        // Arrange
        RecordClassId? null1 = null;
        RecordClassId? null2 = null;
    ...
    public void GetHashCode_ForEqualObjects_ShouldBeEqual()
    {
        // Arrange
        var objectId1 = RecordClassId.From(100);
        var objectId2 = RecordClassId.From(100);
    ...
    {
        // Arrange
        var set = new HashSet<RecordClassId>();
        var objectId1 = RecordClassId.From(100);
        var objectId2 = RecordClassId.From(100); // Equal, but different instance
    ...
    {
        // Arrange
        var dictionary = new Dictionary<RecordClassId, string>();
        var key1 = RecordClassId.From(50);
        var key2 = RecordClassId.From(50); // Equal, but different instance
