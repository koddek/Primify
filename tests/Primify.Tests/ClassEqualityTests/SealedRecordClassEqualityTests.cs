...
public class SealedRecordClassEqualityTests
{
    //================================================================================
    ...
    public void From_CreatesInstanceWithCorrectValue()
    {
        ...
        // Act
        var objectId = SealedRecordClassId.From(value);
    ...
    public void ExplicitCast_FromUnderlyingType_CreatesInstance()
    {
        ...
        // Act
        var objectId = (SealedRecordClassId)value;
    ...
    {
        // Arrange
        var objectId = SealedRecordClassId.From(123);
        var expectedString = $"{nameof(SealedRecordClassId)} {{ Value = 123 }}";
    ...
    {
        // Arrange
        var objectId1 = SealedRecordClassId.From(100);
        var objectId2 = SealedRecordClassId.From(100); // Different instance, same value
    ...
    public void Equality_ForDifferentValues_ShouldBeFalse()
    {
        // Arrange
        var objectId1 = SealedRecordClassId.From(100);
        var objectId2 = SealedRecordClassId.From(200);
    ...
    {
        // Arrange
        var objectId = SealedRecordClassId.From(100);
    ...
    {
        // Arrange
        SealedRecordClassId? null1 = null;
        SealedRecordClassId? null2 = null;
    ...
    public void GetHashCode_ForEqualObjects_ShouldBeEqual()
    {
        // Arrange
        var objectId1 = SealedRecordClassId.From(100);
        var objectId2 = SealedRecordClassId.From(100);
    ...
    {
        // Arrange
        var set = new HashSet<SealedRecordClassId>();
        var objectId1 = SealedRecordClassId.From(100);
        var objectId2 = SealedRecordClassId.From(100); // Equal, but different instance
    ...
    {
        // Arrange
        var dictionary = new Dictionary<SealedRecordClassId, string>();
        var key1 = SealedRecordClassId.From(50);
        var key2 = SealedRecordClassId.From(50); // Equal, but different instance
